...
var curve25519 = function () {
    ...
    function c255laddmodp (r, a, b) {
        ...
        r[1] = (v = ((v / 0x10000) | 0) + a[1] + b[1]) & 0xFFFF;
        r[2] = (v = ((v / 0x10000) | 0) + a[2] + b[2]) & 0xFFFF;
        r[3] = (v = ((v / 0x10000) | 0) + a[3] + b[3]) & 0xFFFF;
        r[4] = (v = ((v / 0x10000) | 0) + a[4] + b[4]) & 0xFFFF;
        r[5] = (v = ((v / 0x10000) | 0) + a[5] + b[5]) & 0xFFFF;
        r[6] = (v = ((v / 0x10000) | 0) + a[6] + b[6]) & 0xFFFF;
        r[7] = (v = ((v / 0x10000) | 0) + a[7] + b[7]) & 0xFFFF;
        r[8] = (v = ((v / 0x10000) | 0) + a[8] + b[8]) & 0xFFFF;
        r[9] = (v = ((v / 0x10000) | 0) + a[9] + b[9]) & 0xFFFF;
        r[10] = (v = ((v / 0x10000) | 0) + a[10] + b[10]) & 0xFFFF;
        r[11] = (v = ((v / 0x10000) | 0) + a[11] + b[11]) & 0xFFFF;
        r[12] = (v = ((v / 0x10000) | 0) + a[12] + b[12]) & 0xFFFF;
        r[13] = (v = ((v / 0x10000) | 0) + a[13] + b[13]) & 0xFFFF;
        r[14] = (v = ((v / 0x10000) | 0) + a[14] + b[14]) & 0xFFFF;
    ...
    function c255lsubmodp (r, a, b) {
        ...
        r[1] = (v = ((v / 0x10000) | 0) + 0x7fff8 + a[1] - b[1]) & 0xFFFF;
        r[2] = (v = ((v / 0x10000) | 0) + 0x7fff8 + a[2] - b[2]) & 0xFFFF;
        r[3] = (v = ((v / 0x10000) | 0) + 0x7fff8 + a[3] - b[3]) & 0xFFFF;
        r[4] = (v = ((v / 0x10000) | 0) + 0x7fff8 + a[4] - b[4]) & 0xFFFF;
        r[5] = (v = ((v / 0x10000) | 0) + 0x7fff8 + a[5] - b[5]) & 0xFFFF;
        r[6] = (v = ((v / 0x10000) | 0) + 0x7fff8 + a[6] - b[6]) & 0xFFFF;
        r[7] = (v = ((v / 0x10000) | 0) + 0x7fff8 + a[7] - b[7]) & 0xFFFF;
        r[8] = (v = ((v / 0x10000) | 0) + 0x7fff8 + a[8] - b[8]) & 0xFFFF;
        r[9] = (v = ((v / 0x10000) | 0) + 0x7fff8 + a[9] - b[9]) & 0xFFFF;
        r[10] = (v = ((v / 0x10000) | 0) + 0x7fff8 + a[10] - b[10]) & 0xFFFF;
        r[11] = (v = ((v / 0x10000) | 0) + 0x7fff8 + a[11] - b[11]) & 0xFFFF;
        r[12] = (v = ((v / 0x10000) | 0) + 0x7fff8 + a[12] - b[12]) & 0xFFFF;
        r[13] = (v = ((v / 0x10000) | 0) + 0x7fff8 + a[13] - b[13]) & 0xFFFF;
        r[14] = (v = ((v / 0x10000) | 0) + 0x7fff8 + a[14] - b[14]) & 0xFFFF;
    ...
    function c255lmulasmall (r, a, m) {
        var v;
        r[0] = (v = a[0] * m) & 0xFFFF;
        r[1] = (v = ((v / 0x10000) | 0) + a[1]*m) & 0xFFFF;
        r[2] = (v = ((v / 0x10000) | 0) + a[2]*m) & 0xFFFF;
        r[3] = (v = ((v / 0x10000) | 0) + a[3]*m) & 0xFFFF;
        r[4] = (v = ((v / 0x10000) | 0) + a[4]*m) & 0xFFFF;
        r[5] = (v = ((v / 0x10000) | 0) + a[5]*m) & 0xFFFF;
        r[6] = (v = ((v / 0x10000) | 0) + a[6]*m) & 0xFFFF;
        r[7] = (v = ((v / 0x10000) | 0) + a[7]*m) & 0xFFFF;
        r[8] = (v = ((v / 0x10000) | 0) + a[8]*m) & 0xFFFF;
        r[9] = (v = ((v / 0x10000) | 0) + a[9]*m) & 0xFFFF;
        r[10] = (v = ((v / 0x10000) | 0) + a[10]*m) & 0xFFFF;
        r[11] = (v = ((v / 0x10000) | 0) + a[11]*m) & 0xFFFF;
        r[12] = (v = ((v / 0x10000) | 0) + a[12]*m) & 0xFFFF;
        r[13] = (v = ((v / 0x10000) | 0) + a[13]*m) & 0xFFFF;
        r[14] = (v = ((v / 0x10000) | 0) + a[14]*m) & 0xFFFF;
